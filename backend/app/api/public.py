...
async def get_public_service_booklet(
    ...
    for r in service_records:
        ...
        formatted_records.append({
            ...
            "parts_cost": r.cost_parts if vehicle.public_show_costs else None,
            "labor_cost": r.cost_labor if vehicle.public_show_costs else None,
    ...
    for t in tyre_sets:
        formatted_tyres.append({
            ...
            "size": t.size,
            "year": (t.purchase_date.year if t.purchase_date else None),
            "dot_code": t.dot_code,
