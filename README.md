...
Текущая версия: **v2.9.0 (Standalone Offline Mobile App, Capacitor Android Engine & Local Database)**
...
* **📥 Установка и сборка APK**:
  * **Готовый APK:** доступен для скачивания в разделе [Releases](https://github.com/scanek/to_auto/releases) (файл `AutoTracker-v2.9.0.apk`).
