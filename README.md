...
Текущая версия: **v2.5.0 (StarLine S96 Telematics & CAN/OBD Live Sync)**
...
### 🛰️ 6.1. Телематика StarLine S96 и авто-синхронизация по CAN/OBD
* **Прямая интеграция со StarLine Open API (starline-online.ru / developer.starline.ru)**:
  ...
  * **Виджет телеметрии в реальном времени**: вольтаж аккумулятора (🔋 АКБ в Вольтах), уровень топлива в баке (⛽ в %), температура двигателя (🌡️ в °C).
  * **Кнопка «🔄 Обновить со StarLine» в 1 клик**: моментальная актуализация данных в карточке машины.
