...
Текущая версия: **v2.6.0 (StarLine Telematics Pro, GPS Anti-Spoofing & LBS Base Station Sync)**
...
* **Детальные параметры машины**:
  ...
  * **Объем топливного бака (в литрах)**: расчет точного остатка топлива в баке в реальном времени.
