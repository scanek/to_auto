    ...
    <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-4 sm:py-8 space-y-4 sm:space-y-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-4">
        <div className="bg-white dark:bg-dark-850 border border-slate-200 dark:border-dark-750 p-4 sm:p-5 rounded-2xl flex items-center justify-between shadow-sm">
          <div>
            <span className="text-[11px] sm:text-xs font-semibold uppercase text-slate-500 dark:text-slate-400">Автомобилей в гараже</span>
            <div className="text-xl sm:text-2xl font-extrabold text-slate-900 dark:text-white mt-0.5">{vehicles.length}</div>
          </div>
        ...
        <div className="bg-white dark:bg-dark-850 border border-slate-200 dark:border-dark-750 p-4 sm:p-5 rounded-2xl flex items-center justify-between shadow-sm">
          <div>
            <span className="text-[11px] sm:text-xs font-semibold uppercase text-slate-500 dark:text-slate-400">Напоминаний к ТО</span>
        ...
        <div className="bg-white dark:bg-dark-850 border border-slate-200 dark:border-dark-750 p-4 sm:p-5 rounded-2xl flex items-center justify-between shadow-sm">
          <div>
            <span className="text-[11px] sm:text-xs font-semibold uppercase text-slate-500 dark:text-slate-400">Всего расходов</span>
      ...
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
          <div>
            <h2 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white tracking-tight">Ваш гараж</h2>
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-3 pt-2.5 border-t border-slate-100 dark:border-dark-750">
                      <div className="bg-slate-50 dark:bg-dark-900/70 p-2 sm:p-2.5 rounded-xl border border-slate-200 dark:border-dark-750/70">
                        ...
                        <span className="text-xs sm:text-sm font-bold text-slate-900 dark:text-white font-mono block">
                          ...
                          <span className="text-[10px] text-slate-500 font-sans">{v.distance_unit}</span>
                        </span>
