...
export const PublicServiceBooklet: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-slate-100 pb-16 font-sans">
      ...
      <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-30 shadow-xs">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a
              href={`/api/v1/public/booklet/${token}/print`}
              target="_blank"
              rel="noreferrer"
      ...
      {/* Unified Footer */}
      <footer className="w-full border-t border-slate-200 dark:border-dark-800 bg-white/80 dark:bg-dark-900/80 backdrop-blur-sm py-4 px-4 sm:px-6 mt-12 text-center transition-colors">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500 dark:text-slate-400 font-medium">
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
            <span>Электронная сервисная книжка • AutoTracker</span>
            <span>•</span>
